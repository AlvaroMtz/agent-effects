...
|-------|------------|------------|------------------------------|
| Slice 1a — Workspace + core types + contracts | Tasks 1–3 | ~315 | AC2, AC3, AC11; AC1 first half (install + harness) |
...
- [ ] 1. Root workspace + core package scaffolding (scaffolding-first: no test is runnable before this task).
...
- [ ] 2. Core value types — Effect, EffectResult, supporting types (strict TDD inside this task).
...
- [ ] 3. Core journal + executor contracts, incl. JournalInvariantError (strict TDD inside this task).
